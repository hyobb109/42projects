...
void ShrubberyCreationForm::execute(Bureaucrat const& executor) const {
  ...
  std::string tree =
     ...
     \033[0;34m*\033[0;33m                 /.-.\\         \033[0;34m*\033[0m\n\
              \033[0;34m*\033[0m        \033[0;32m`/&\\`                   \033[0;34m*\033[0m\n\
                      \033[0;32m,@.*;@,\n\
                     /_o.I %_\\    \033[0;34m*\033[0m\n\
        \033[0;34m*\033[0m           \033[0;32m(`'--:o(_@;\n\
                   /`;--.,__ `')             \033[0;34m*\033[0m\n\
                  \033[0;32m;@`o % O,*`'`&\\\n\
            \033[0;34m*\033[0m    \033[0;31m(`'--)_@ ;o %'()\\      \033[0;34m*\033[0m\n\
                 \033[0;32m/`;--._`''--._O'@;\n\
                /&*,()~o`;-.,_ `\"\"`)\n\
     \033[0;34m*\033[0m          \033[0;32m/`,@ ;+& () o*`;-';\\\n\
               \033[0;32m(`\"\"--.,_0 +% @' &()\\\n\
               /-.,_    ``''--....-'`)  \033[0;34m*\033[0m\n\
          \033[0;34m*\033[0m    \033[0;32m/@%;o`:;'--,.__   __.'\\\n\
              ;*,&(); @ % &^;~`\"`o;@();         \033[0;34m*\033[0m\n\
              \033[0;32m/(); o^~; & ().o@*&`;&%O\\\n\
              `\"=\"==\"\"==,,,.,=\"==\"===\"`\n\
